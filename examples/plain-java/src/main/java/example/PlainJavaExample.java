...
public final class PlainJavaExample {
    ...
    private static void runSynthetic() {
        ...
        System.out.printf(
                "refund: configured=%s, stricter override=%s%n",
                refund.isTrue(), refund.isTrueAt(0.80));
        ...
        EnumScoreAnswer<Urgency> urgency =
                URGENCY.answer(
                        1.5,
                        Map.of(Urgency.LOW, 0.10, Urgency.MEDIUM, 0.40, Urgency.HIGH, 0.50),
                        0.90);
